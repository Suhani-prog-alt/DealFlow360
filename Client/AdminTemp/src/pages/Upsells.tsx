...
export default function Upsells() {
  const columns = [
    ...
    { key: 'priority', label: 'Priority', options: ['High', 'Medium', 'Low'], render: (v: string) => <span className={'px-2 py-1 rounded text-xs font-medium ' + (v === 'High' ? 'bg-[#db7b5e]/10 text-[#db7b5e]' : v === 'Medium' ? 'bg-[#e69865]/10 text-[#e69865]' : 'bg-gray-700/50 text-gray-400')}>{v}</span> },
