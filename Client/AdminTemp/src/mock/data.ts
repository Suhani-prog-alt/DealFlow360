...
export const initialDiscountRules = [
  ...
  { id: '4', customerTier: 'Gold', categoryId: 'cat-2', maxDiscount: 10, createdAt: new Date().toISOString() },
];
...
export const initialAuditLogs = [
  { id: '1', user: 'Admin', action: 'CREATE', entity: 'Product', details: 'Added Enterprise Laptop Pro', createdAt: new Date(Date.now() - 86400000).toISOString() },
  { id: '2', user: 'Admin', action: 'UPDATE', entity: 'DiscountRule', details: 'Hardware category discount limit lowered to 15%', createdAt: new Date(Date.now() - 43200000).toISOString() },
  { id: '3', user: 'Admin', action: 'CREATE', entity: 'Warehouse', details: 'Admin added North Warehouse location', createdAt: new Date(Date.now() - 28800000).toISOString() },
  { id: '4', user: 'Admin', action: 'UPDATE', entity: 'SubscriptionPlan', details: 'Silver Tier subscription proration updated', createdAt: new Date(Date.now() - 18000000).toISOString() },
  { id: '5', user: 'Admin', action: 'CREATE', entity: 'ApprovalChain', details: 'Added Manager Review', createdAt: new Date(Date.now() - 14400000).toISOString() },
  { id: '6', user: 'Admin', action: 'UPDATE', entity: 'PriceList', details: 'Updated Gold Tier Pricing', createdAt: new Date(Date.now() - 10800000).toISOString() },
  { id: '7', user: 'Admin', action: 'CREATE', entity: 'UpsellRule', details: 'Added cross-sell for Laptop to Switch', createdAt: new Date(Date.now() - 7200000).toISOString() },
  { id: '8', user: 'System', action: 'DELETE', entity: 'Product', details: 'Removed old workstation', createdAt: new Date(Date.now() - 3600000).toISOString() },
  { id: '9', user: 'Admin', action: 'UPDATE', entity: 'Warehouse', details: 'Updated Central Warehouse capacity', createdAt: new Date(Date.now() - 1800000).toISOString() },
